  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved personal as @personal" do
        ...
        post :create, {:personal => { "user_id" => "invalid value" }}, valid_session
        assigns(:personal).should be_a_new(Personal)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested personal" do
        ...
        Personal.any_instance.should_receive(:update).with({ "user_id" => "1" })
        put :update, {:id => personal.to_param, :personal => { "user_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the personal as @personal" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Personal.any_instance.stub(:save).and_return(false)
        put :update, {:id => personal.to_param, :personal => { "user_id" => "invalid value" }}, valid_session
        assigns(:personal).should eq(personal)
      end
